...
import com.app.catalog.presentation.components.CarouselWithIndicator
import com.app.catalog.presentation.home.components.CatalogItem
import com.app.catalog.presentation.home.components.CatalogRangeItem
import com.app.catalog.presentation.home.components.CatalogRangeLoading
import com.app.catalog.presentation.home.components.NoItemFound
import com.app.catalog.presentation.home.components.SearchBox
...
fun HomePage(viewModel: HomePageViewModel = hiltViewModel()) {
    ...
    val catalogRange by viewModel.catalogRange.collectAsState()
    val catalogAnalysis by viewModel.catalogAnalysis.collectAsState()
    val showBottomSheet by viewModel.showBottomSheet.collectAsState()
    val catalogRangeLoading by viewModel.catalogRangeLoading.collectAsState()
